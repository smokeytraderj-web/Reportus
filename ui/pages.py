...
class HomePage(QWidget):
    ...
    def __init__(self, workflows: tuple[ReportWorkflow, ...], parent=None):
        ...
        layout.setContentsMargins(48, 30, 48, 38)
        layout.setSpacing(12)

        hero = QFrame()
        hero.setObjectName("HomeHero")
        hero.setMinimumHeight(184)
        hero_layout = QVBoxLayout(hero)
        hero_layout.setContentsMargins(34, 26, 34, 27)
        hero_layout.setSpacing(8)

        eyebrow = QLabel("PRIVATE WEALTH REPORTING")
        eyebrow.setObjectName("Eyebrow")
        title = QLabel("What would you like to build?")
        title.setObjectName("HeroTitle")
        subtitle = QLabel(
            "Create polished, verified reports with the same clarity and care clients expect."
        )
        subtitle.setObjectName("HeroSubtitle")
        subtitle.setWordWrap(True)
        gold_rule = QFrame()
        gold_rule.setObjectName("GoldRule")
        gold_rule.setFixedWidth(64)
        hero_layout.addWidget(eyebrow)
        hero_layout.addWidget(title)
        hero_layout.addWidget(gold_rule)
        hero_layout.addWidget(subtitle)
        layout.addWidget(hero)
        layout.addSpacing(13)

        reports_label = QLabel("REPORT TYPES")
        reports_label.setObjectName("SectionEyebrow")
...
class IntakePage(QWidget):
    ...
    def __init__(
        ...
        eyebrow = QLabel("REPORT BUILDER")
        eyebrow.setObjectName("SectionEyebrow")
        root.addWidget(eyebrow)
        self.title = QLabel()
        self.title.setObjectName("PageTitle")
        heading_rule = QFrame()
        heading_rule.setObjectName("GoldRule")
        heading_rule.setFixedWidth(52)
        self.subtitle = QLabel()
        self.subtitle.setObjectName("Muted")
        root.addWidget(self.title)
        root.addWidget(heading_rule)
